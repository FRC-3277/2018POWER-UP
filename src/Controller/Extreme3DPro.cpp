...
namespace UserDefinedController {
	...
	Extreme3D_Pro::ControllerButtonMapping Extreme3D_Pro::GetButtonMap(const std::string& givenButtonName)
	{
		...
		{
			lumberJack->eLog(std::string(__FILE__) + "; Requested button map Extreme3D_Pro not found: " + givenButtonName);
			throw ERR::CustomError(std::string(__FILE__) + "; Requested button map Extreme3D_Pro not found; " + givenButtonName);
		}
